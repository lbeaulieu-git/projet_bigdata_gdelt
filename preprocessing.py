...
def requete_4(gkg_translation):
    ...
    requete4 = gkg_translation.loc[:, ["gkg_translation_0",
                                       "gkg_translation_7",
                                       "gkg_translation_11",
                                       "gkg_translation_9",
                                       "gkg_translation_15",
    ...
    # requete4.to_csv('out/requete4.csv', index=False)
    requete4.to_csv(r'/home/ubuntu/csv/requete4/requete4.csv', index=False)
